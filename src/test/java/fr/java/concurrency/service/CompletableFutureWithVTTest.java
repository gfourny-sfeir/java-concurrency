 ...
 * @author gfourny
 */
class CompletableFutureWithVTTest {

    private final CompletableFutureWithVT completableFutureWithVT = new CompletableFutureWithVT();
    ...
    void drink() {
        ...
        await().atMost(Duration.ofMillis(1700)).until(() ->
                {
                    Dilly dilly = completableFutureWithVT.async();
